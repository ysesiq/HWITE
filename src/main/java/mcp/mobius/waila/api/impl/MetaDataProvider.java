...
public class MetaDataProvider {
    ...
    public ItemStack identifyBlockHighlight(World world, EntityPlayer player, RaycastCollision mop,
    ...
    public List<String> handleBlockTextData(ItemStack itemStack, World world, EntityPlayer player,
            RaycastCollision mop, DataAccessorCommon accessor, List<String> currenttip, Layout layout) {
        Block block = accessor.getBlock();
