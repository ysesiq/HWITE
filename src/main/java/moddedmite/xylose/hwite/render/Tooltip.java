...
public class Tooltip {
    ...
    static ArrayList<Renderable> elements = new ArrayList<>();
    ...
    static RaycastCollision accessor = Minecraft.theMinecraft.objectMouseOver;

    ///////////////////////////////////// Renderable///////////////////////////////////////
    static class Renderable {
...
//
        ...
        public Dimension getSize(RaycastCollision accessor) {
...
//                WailaExceptionHandler.handleErr(e, this.renderer.getClass().getName() + ".getSize()", null);
        ...
        public void draw(RaycastCollision accessor, int x, int y) {
            GL11.glPushMatrix();
...
//                WailaExceptionHandler.handleErr(e, this.renderer.getClass().getName() + ".draw()", null);
    ...
    public Tooltip(java.util.List<String> textData, ItemStack stack) {
        this(textData, true);
        this.stack = stack;
    }
...
//    }
    ...
    private void computePositionAndSize(boolean hasIcon) {
        ...
        x = ((int) (size.width / 1) - w - 1) * pos.x / 10000;
        y = ((int) (size.height / 1) - h - 1) * pos.y / 10000;
