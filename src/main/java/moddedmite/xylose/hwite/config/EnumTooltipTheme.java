...
public enum EnumTooltipTheme {
    ...
    EnumTooltipTheme(String backgroundColor, String frameColorTop, String frameColorBottom) {
    ...
    EnumTooltipTheme(int BGColor, int frameColorTop, int frameColorBottom) {
