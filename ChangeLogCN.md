...
## v1.5.0
* 优化了代码
* 优化了挖掘速度显示,现在不再取整,而是保留2位小数
* 优化了伤害显示,现在保留2位小数
* 修复了因看向血量过高的生物无响应的问题
* 修复了与`MITE-ITE`模组的兼容性问题

---

## v1.4.8
* 现在可隐藏模组名称
* 修复了强制需要ModMenu作为前置的问题

---

## v1.4.7
* 现在需要ManyLib 2.2.0作为前置
* 优化了对EMI的联动
* 移除了一些ManyLib 2.1.0的旧写法,改为ManyLib 2.2.0的新写法
* 加入了Icon并添加了对ModMenu的适配
* 优化了提示框

---

## v1.4.6
* 现在不强制要求EMI以及PinIn-Lib作为前置,如需使用查看配方/查看用法热键请安装EMI v1.0.4
...
## v1.4.0
* 当显示Boss血条或开发模式时,Tooltip会自动下移
* 显示缩放最小值改为0.2
* 修改了配置的排列与命名
* 小于等于20的血量会以♥显示
* 修改了挖掘提示,现在显示[需求挖掘工具:挖掘等级:能否挖掘]
* 加入了未完成的状态效果显示,目前仅能显示首个
* 添加了一些配置项
* 加入了主题:成就框
* 修复了关闭方块渲染配置不生效的问题
* 修改了软件包名
